const config = {
    ...
    "agents": [
      {
        ...
        "contactDetails": [
          {
            "type": "email",
            "value": "contact@mylesschwartz.com"
          },
          {
            "type": "phone",
            "value": "647-999-5594"
  ...
  "mainBox": {
    ...
    "sidebar": {
      ...
      "paragraphs": [
        "At {{companyName}} real estate we provide professional real estate services with integrity, expertise, and dedication to our clients' success. Our experienced team combines market knowledge with personalized service to help you achieve your real estate goals. Whether you're buying, selling, or investing, we're here to guide you through every step of the process with transparency and results-driven strategies."
      ]
    }
  },
  "sections": [
    ...
    },
    {
      ...
      "ctaBannerContent": {
        ...
        "headline": "Get Your Free Market Position Analysis - I'll show you exactly how to make your home irresistible to buyers in today's challenging market, just like Sarah and Michael's success story.",
